...
const Hero: React.FC = () => {
  return (
    <section className="py-20 text-center">
      ...
      <p className="text-xl mb-8 max-w-2xl mx-auto">Harness the power of artificial intelligence to streamline your workflow, boost productivity, and unlock new possibilities.</p>
